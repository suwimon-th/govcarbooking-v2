...
export default function ReportsClient({ viewMode }: { viewMode: 'MONTHLY' | 'FUEL' | 'ANNUAL' }) {
    const { can } = useAccess();
    ...
    const handleFetchReport = async () => {
        const permission = viewMode === "MONTHLY" ? "reports" : viewMode === "FUEL" ? "reports.fuel" : "reports.annual";
        ...
        try {
            if (viewMode === 'MONTHLY') {
                ...
                if (!res.ok) throw new Error(json.error || "ไม่สามารถโหลดรายงานได้");
        ...
        <div className="p-6 max-w-[1400px] mx-auto min-h-screen">
            <div className="print:hidden">
                ...
                <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-xl p-1 shadow-sm w-fit mb-6 overflow-x-auto">
                    ...
                    {can("reports.fuel") && (<Link
                        href="/admin/reports/fuel"
